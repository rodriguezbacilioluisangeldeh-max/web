...
<section>
		...
		<div class="derecha">
			<h2>OPERADOR TERNARIO. SINTAXIS: </h2>

	<h3>CONDICION ? "ALGO AQUI. SI ES VERDAD" : "ALGO AQUI SI NO ES VERDAD"; o</h3>

	<h3>$var = (CONDICION) ? "ALGO AQUI. SI ES VERDAD" : "ALGO AQUI SI NO ES VERDAD";</h3>
...
echo $mi_edad>=18 ? "puedes votar":"no puedes votar"."<br>";

echo "<br>";


$resul=($mi_edad>=18)?"puedes votar":"no puedes votar";

echo "$resul <br>";

//hacerlo con un if / luego pedir datos con un formulario / validar con operadores de comparacion nom y pass
echo "<br>";
echo "<br>";
