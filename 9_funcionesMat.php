...
<section>
		...
		<div class="derecha">
			...
			<H3>FUNCIONES MATEMATICAS PREDEFINIDAS POR EL LENGUAJE</H3>

			<p>Las funciones predefinidas en PHP son código ya escrito que está incluido en el propio lenguaje, diseñado para realizar tareas específicas de forma rápida y eficiente. Permiten a los desarrolladores ejecutar operaciones comunes, como el manejo de cadenas, arrays o cálculos numéricos, sin tener que escribir el código desde cero. Estas funciones hacen el desarrollo más limpio y menos propenso a errores, ahorrando tiempo y esfuerzo. </p>

	<ul>
		<li>USO DE FUNCIONES MATEMATICAS</li>
		<?php 
$num=-100.66;
$num2=100.66;
echo abs($num)."<br>";
...
echo "implementar 5 funciones matematicas mas de php";
echo "<br>";
echo "<br>";

echo "el boleto ganador es el : ".$ganador;


		 ?>
		<li>QUE ES EL CASTING</li>
		<p>El "casting" en PHP es la conversión de un valor de un tipo de dato a otro, lo que puede ser implícito (automático, realizado por PHP) o explícito (manual, realizado por el programador). Es una herramienta útil para garantizar que las variables se utilicen con el tipo de dato correcto, por ejemplo, al procesar entradas del usuario o al interactuar con bases de datos</p>

		<?php 
		$valor1=10;
		$valor2="10";
		$resul=$valor1+$valor2;
		echo "casting automatico por php"."<br>";
		var_dump($resul);

		$cadena = "123"; //seguido de 
		$entero = (int) $cadena; //asignará el valor numérico 123 a $entero
		echo "<br>";
		echo "$entero";

		 ?>
	</ul>
	<a href="https://www.php.net/manual/es/indexes.functions.php">para mas informacion</a>
		</div>
