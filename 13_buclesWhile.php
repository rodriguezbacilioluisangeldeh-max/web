...
<section>
		...
		<div class="derecha">
			<h2>ESTRUCTURA CONDICIONAL WHILE </h2>
	
	<H2>BUCLES</H2>
	<UL>
		<LI>QUE SON LOS BUCLES:</LI>
			<p>Estructuras Repetitivas.</p>
		<LI>PARA QUE SIRVEN:</LI>
			<p> para que Repitan el codigo de su interior, existen dos tipos. los indeterminados while y do- while y los determinados. este es el ciclo for ();</p>
		<LI>BUCLE while</LI>

		<p>Ejemplo del bucle while</p>

		<?php 
		$mi_var = 1;//poner la variable con valor 10;

		while ($mi_var<=10) {

			echo "hola estamos ejecutando el codigo del bucle ";
			echo "<br>";
			$mi_var++;
			...
			echo "<br>";
			echo "hemos salido del bucle while";
...
//-----------------------------------------------------
	...
	<?php 
		...
		echo "<p>Ejemplo del bucle do wile</p><br>";
		
		$mi_var = 20; //probar con un valor menor para que funcione igual que el while.
